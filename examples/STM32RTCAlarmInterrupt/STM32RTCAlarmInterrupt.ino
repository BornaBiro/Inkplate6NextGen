/*
   This example shows how to use STM32H743 (Inkplate NextGen) internal RTC to make interrupt on alarm event.
...
void setup()
{
  ...
  rtc.enableAlarmInterrupt(alarmFunction);
}
...
// Function that is called when alarm event happens
void alarmFunction()
{
  alarmFlag = true;
}
