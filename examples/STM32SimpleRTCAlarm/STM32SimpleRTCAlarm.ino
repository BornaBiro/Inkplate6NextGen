/*
   This example shows how to use STM32H743 (Inkplate NextGen) internal RTC to make alarm event
...
void loop()
{
  ...
  if (rtc.checkForAlarm()) Serial.println("ALARM EVENT!");
}
